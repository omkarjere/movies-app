...
<div class="tv-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="no-flex">
            <img src="{{ $tvShow['poster_path'] }}" class="w-64 md:w-96" alt="parasite">
        </div>
        <div class="md:ml-24">
            <h2 class="text-4xl font-semibold">{{ $tvShow['name'] }}({{ $tvShow['release_year'] }})</h2>
            ...
            <p class="text-gray-400 mt-10">{{ $tvShow['overview'] }}</p>
            <div class="mt-12">
                <div class="flex mt-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div class="mt-8">
                <a href="{{ route('actors.show', $cast['id']) }}">
                    <img src="https://image.tmdb.org/t/p/w500{{ $cast['profile_path'] }}" alt="profile_path"
